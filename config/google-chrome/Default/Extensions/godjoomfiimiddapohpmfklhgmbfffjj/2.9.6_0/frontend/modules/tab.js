...
(function() {
  ...
  Tab = (function() {
    ...
    desc(Tab.reloadWithoutCache, "Reload  (no cache)");
    ...
    desc(Tab.toggleIncognito, "Toggle incognito mode for current tab (need to enable Vrome in incognito mode)");
    ...
    desc(Tab.markForMerging, "Toggle marks current tab for merging (can mark multiple tabs)");
    ...
    desc(Tab.close, "Quit current tab");
