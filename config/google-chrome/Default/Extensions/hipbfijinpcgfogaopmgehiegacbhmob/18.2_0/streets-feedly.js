...
//								"adzModule",
	...
	addSubscriptionForm:
	{
		...
		dependencies: [ "reader", "dialog", "signs", "analytics" ]
	},
...
// ---------------------------------------------------------------------
	...
	discoverModule:
	{
		...
		dependencies: [ "reader", "preferences", "suggesto", "feedly", "trends", "analytics" ]
	},
...
// ---------------------------------------------------------------------
	...
	store:
	{
		...
		dependencies: [ "repo", "preferences", "reader", "feedly", "twitter", "sherlock", "adz", "suggesto", "analytics" ]
	},
