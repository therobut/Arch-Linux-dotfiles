...
$A(_,templates.forms.buttonField( { label: _L(212), id: "facebookCancelAction", secondary: true } ));
$A(_,templates.forms.buttonField( { label: _L(213),  id: "facebookSendAction",   secondary: false } ));
$A(_,$[14],s3('loading.gif'),$[15],$L(214),$[16]);
return _.join($E);
}
$=[
