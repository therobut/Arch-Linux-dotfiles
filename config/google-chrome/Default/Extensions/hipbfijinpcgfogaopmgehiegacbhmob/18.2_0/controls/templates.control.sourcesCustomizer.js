...
$A(_,$[0],s3('customizer-checkbox-unchecked.png'),$[1]);
return _.join($E);
}
$=[
" \n<div id=\"sourcesMustReadsOnly\"> \n<span id=\"sourcesMustReadsOnlyToggle\" class=\"checkable\" style=\"padding-right:8px\"> \n<img id=\"sourcesMustReadsOnlyCheck\" \nsrc=\"","\" \nwidth=\"12\" height=\"12\" align=\"absmiddle\" style=\"padding-bottom: 2px\" \n/> \nMust Reads Only \n</span> \n</div> \n"]
})();
// strings=2 characters=272
